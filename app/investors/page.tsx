...
export default function InvestorsPage() {
  return <main className="min-h-screen bg-slate-950 px-4 py-6 text-slate-100 md:px-8"><div className="mx-auto max-w-6xl space-y-5">
    ...
    <header className="py-4"><p className="text-xs uppercase tracking-[0.25em] text-cyan-300">Smart Money Sensor</p><h1 className="mt-2 text-3xl font-semibold">明星投资人</h1><p className="mt-3 text-sm text-slate-400">追踪谁说了什么、哪个账户买卖、哪只基金持有。新增投资人名单待确认。</p></header>
